...
/// These tokens mirror the current HADIR web visual system while keeping
/// existing Flutter screens, routes and data flows unchanged.
class HadirBrand {
  ...
  static const danger = Color(0xFFD9433A);
  static const warning = Color(0xFFF59E0B);
  static const success = Color(0xFF0B6B5A);

  static const darkBackground = Color(0xFF0C1714);
  static const darkCard = Color(0xFF14221E);
  static const darkPanel = Color(0xFF1B302A);
  static const darkText = Color(0xFFF1F7F4);
  static const darkMuted = Color(0xFFAABCB6);
  static const darkBorder = Color(0xFF29443C);
  static const darkPrimary = Color(0xFF36B58F);
  static const darkSoft = Color(0xFF173B31);
  ...
  static ThemeData theme({Brightness brightness = Brightness.light}) {
    ...
    final scheme = ColorScheme.fromSeed(
      ...
      outline: outline,
      error: dark ? const Color(0xFFFF7B83) : danger,
    );
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: dark ? surfacePanel : Colors.white,
      ...
      chipTheme: ChipThemeData(
        ...
        labelStyle: TextStyle(color: foreground, fontSize: 11, fontWeight: FontWeight.w700),
      ),
      switchTheme: SwitchThemeData(
        thumbColor: WidgetStateProperty.resolveWith((states) => states.contains(WidgetState.selected) ? primaryColor : secondaryText),
        trackColor: WidgetStateProperty.resolveWith((states) => states.contains(WidgetState.selected) ? primaryColor.withValues(alpha: .28) : outline),
      ),
