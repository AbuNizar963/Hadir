...
const controls = [
  ...
  { id: "rotationDays", title: "أيام التناوب للموظفين التناوبيين", description: "تطبيق عدد أيام العمل وأيام الراحة على الموظفين من نوع الدوام التناوبي فقط.", icon: <Icon><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M8 3v4M16 3v4M3 10h18"/><path d="m8 15 2 2 5-5"/></Icon> },
  ...
  const run = async () => {
    ...
    try {
      ...
      if (selected === "password") {
        ...
        if (!Number.isInteger(daysOn) || daysOn < 1 || daysOn > 31 || !Number.isInteger(daysOff) || daysOff < 0 || daysOff > 31) throw new Error("أيام العمل يجب أن تكون: 1–31 يومًا، والراحة 0–31 يومًا.");
        ...
        setMessage(`تم تحديث دورة التناوب لـ ${result.updated} موظفًا تناوبيًا: ${daysOn} أيام عمل + ${daysOff} أيام راحة.`);
