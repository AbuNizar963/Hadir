...
>(({ className, children, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    {...props}
  >
    <span className="inline-flex items-center gap-2 [&>svg]:h-4 [&>svg]:w-4 [&>svg]:shrink-0 [&>svg]:transition-transform [&>svg]:duration-200 group-hover:[&>svg]:scale-105 group-data-[state=active]:[&>svg]:text-primary">
      {children}
    </span>
  </TabsPrimitive.Trigger>
))
