...
const statusLabels: Record<string, string> = { PRESENT: "حاضر", LATE: "متأخر", ABSENT: "غياب", LEAVE: "إجازة", PERMISSION: "استئذان", REST: "راحة", ESCAPED: "هروب", NOT_STARTED: "لم يبدأ", INVALID: "غير صالح" };
...
const exceptionLabels: Record<string, string> = { MISSING_CHECKOUT: "انصراف معلق", CHECKOUT_WITHOUT_CHECKIN: "انصراف دون حضور", ABSENT_NO_APPROVED_REASON: "غياب دون عذر معتمد", LATE_ARRIVAL: "تأخر في الحضور", EARLY_LEAVE: "انصراف مبكر", OVERTIME: "عمل إضافي" };
