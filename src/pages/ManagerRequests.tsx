...
export default function ManagerRequests() {
  ...
  const load = async () => { try { setError(""); setRequests(await getBackendRequests()); } catch (e) { setError(e instanceof Error ? e.message : "تعذر تحميل الطلبات"); } finally { setLoading(false); } };
  useEffect(() => { void load(); }, []);
