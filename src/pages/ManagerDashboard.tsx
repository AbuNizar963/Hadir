...
export default function ManagerDashboard() {
  ...
  const decideRequest = async (request: EmployeeRequest, status: "approved" | "rejected") => {
    ...
    try {
      await updateBackendRequest(request.id, status);
