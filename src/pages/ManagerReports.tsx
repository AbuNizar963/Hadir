...
export default function ManagerReports() {
  ...
  return <ManagerLayout title="التقارير" subtitle={title} actions={<div className="flex flex-wrap gap-2"><Button onClick={exportExcel} disabled={!summaries.length}><FileSpreadsheet className="ml-2 h-4 w-4" />Excel</Button><Button variant="outline" onClick={exportCsv} disabled={!summaries.length}><FileText className="ml-2 h-4 w-4" />CSV</Button>{mode === "daily" && <Button variant="outline" onClick={printReport} disabled={!summaries.length}><Printer className="ml-2 h-4 w-4" />طباعة الخدمة</Button>}</div>}>
    ...
    <style>{`@page { size: A4 landscape; margin: 6mm; } @media print { html, body { background: #fff !important; margin: 0 !important; padding: 0 !important; } body * { visibility: hidden; } .service-report, .service-report * { visibility: visible; } .service-report { position: static !important; width: 100% !important; max-width: none !important; margin: 0 !important; padding: 0 !important; border: 0 !important; box-shadow: none !important; overflow: visible !important; } .service-report > div:first-child { padding: 4mm 0 !important; break-inside: avoid; } .service-report > div:nth-child(2) { padding: 2mm 0 !important; } .service-report .grid { gap: 2mm !important; } .service-report table { width: 100% !important; border-collapse: collapse !important; page-break-inside: auto; break-inside: auto; } .service-report thead { display: table-header-group !important; } .service-report tbody { display: table-row-group !important; } .service-report tr { break-inside: avoid !important; page-break-inside: avoid !important; } .service-report td, .service-report th { padding: 1.5mm 2mm !important; } .service-report img { max-height: 12mm !important; } }`}</style>
  </ManagerLayout>;
}
