...
export default function ManagerReports() {
  ...
  return <ManagerLayout title="التقارير" subtitle={title} actions={<div className="flex flex-wrap gap-2"><Button onClick={exportExcel} disabled={!summaries.length}><FileSpreadsheet className="ml-2 h-4 w-4" />Excel</Button><Button variant="outline" onClick={exportCsv} disabled={!summaries.length}><FileText className="ml-2 h-4 w-4" />CSV</Button>{mode === "daily" && <Button variant="outline" onClick={printReport} disabled={!summaries.length}><Printer className="ml-2 h-4 w-4" />طباعة الخدمة</Button>}</div>}>
    ...
    <style>{`@page { size: A4 landscape; margin: 5mm 6mm; } @media print { html, body { background: #fff !important; margin: 0 !important; padding: 0 !important; } body * { visibility: hidden; } .service-report, .service-report * { visibility: visible; } .service-report { position: static !important; width: 100% !important; max-width: none !important; min-height: 0 !important; height: auto !important; margin: 0 !important; padding: 0 !important; border: 0 !important; box-shadow: none !important; overflow: visible !important; display: block !important; } .service-report > div:first-child { padding: 3mm 0 !important; break-inside: avoid; page-break-inside: avoid; } .service-report > div:nth-child(2) { padding: 2mm 0 !important; } .service-report > div:nth-child(2) > .grid { display: block !important; } .service-report > div:nth-child(2) > .grid > div { width: 100% !important; margin: 0 0 3mm !important; break-inside: avoid !important; page-break-inside: avoid !important; } .service-report table { width: 100% !important; height: auto !important; border-collapse: collapse !important; page-break-inside: auto !important; break-inside: auto !important; } .service-report thead { display: table-header-group !important; } .service-report tbody { display: table-row-group !important; } .service-report tr { break-inside: avoid !important; page-break-inside: avoid !important; } .service-report td, .service-report th { padding: 1.2mm 1.8mm !important; line-height: 1.25 !important; } .service-report img { max-height: 10mm !important; } .service-report .bg-slate-100 { background: #f1f5f9 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; } .service-report > div:nth-child(2) > .mt-4 { margin-top: 2mm !important; padding-top: 2mm !important; } }`}</style>
  </ManagerLayout>;
}
