  ...
  return (
    <ManagerLayout title="الموظفون" subtitle="دليل الموظفين الموحد — البيانات من النظام مباشرة.">
      <div className="space-y-5">
        ...
        <section className="hud-card overflow-hidden border-primary/25 bg-primary/[0.025] p-5 sm:p-6"><div className="grid grid-cols-2 gap-3 sm:grid-cols-5"><div className="rounded-2xl border border-border/60 bg-background/30 p-4"><div className="text-xs text-muted-foreground">الإجمالي</div><div className="mono live-value mt-1 text-2xl font-black">{stats.total}</div></div><div className="rounded-2xl border border-primary/20 bg-primary/5 p-4"><div className="text-xs text-muted-foreground">فعال</div><div className="mono live-value mt-1 text-2xl font-black text-primary">{stats.active}</div></div><div className="rounded-2xl border border-destructive/20 bg-destructive/5 p-4"><div className="text-xs text-muted-foreground">موقوف</div><div className="mono live-value mt-1 text-2xl font-black text-destructive">{stats.suspended}</div></div><div className="rounded-2xl border border-border/60 bg-background/30 p-4"><div className="text-xs text-muted-foreground">أجهزة موثقة</div><div className="mono live-value mt-1 text-2xl font-black">{stats.devices}</div></div><div className="rounded-2xl border border-destructive/20 bg-destructive/5 p-4"><div className="text-xs text-muted-foreground">هارب الآن</div><div className="mono live-value mt-1 text-2xl font-black text-destructive">{stats.escaped}</div></div></div></section>
