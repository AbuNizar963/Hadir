  ...
  return <div className="min-h-screen flex flex-col bg-background">
    ...
    <main className="flex-1 grid place-items-center px-5 py-10"><section className="w-full max-w-md">
      ...
      <div className="hud-card p-5 sm:p-6 shadow-sm"><form onSubmit={submit} className="space-y-4">
        ...
        <label className="block"><span className="block text-sm font-bold mb-2">رمز الدخول</span><input type="password" inputMode="text" autoComplete="current-password" className="input w-full p-3.5 rounded-2xl border border-border bg-secondary/45 text-base tracking-[0.3em]" value={pin} onChange={e=>setPin(e.target.value.replace(/[^A-Za-z0-9]/g, ""))} placeholder="ادخل كلمة المرور" required disabled={loading}/></label>
