...
type Weather = { temp:number; apparent:number; code:number; wind:number; humidity:number; uv:number; pressure:number; sunrise:string; sunset:string; timezone:string; city:string; isDay:boolean; hours:Hour[] };
 ...
 const locate=()=>{
   ...
   navigator.geolocation.getCurrentPosition(
     ...
     ()=>{
       navigator.geolocation.getCurrentPosition(
         p=>{setLocating(false);void refresh(p.coords.latitude,p.coords.longitude);},
         ()=>{setLocating(false);setError("تعذر تحديد موقعك. اسمح للموقع من إعدادات المتصفح ثم اضغط «تحديد الموقع» مرة أخرى.");},
