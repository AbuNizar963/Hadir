    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          enabled: !_recoveryLoading,
          obscureText: true,
          decoration: _inputDecoration(hint: 'أدخل رمز الاستعادة', icon: Icons.key_outlined),
        ),
        const SizedBox(height: 12),
        TextField(
          ...
          decoration: _inputDecoration(hint: 'اسم المالك', icon: Icons.person_outline_rounded),
        ),
        const SizedBox(height: 12),
        TextField(
          ...
          enabled: !_recoveryLoading,
          textInputAction: TextInputAction.next,
          decoration: _inputDecoration(hint: 'مثال: owner', icon: Icons.badge_outlined),
        ),
        const SizedBox(height: 12),
        TextField(
          ...
          enabled: !_recoveryLoading,
          obscureText: true,
          decoration: _inputDecoration(hint: '12 حرفًا على الأقل', icon: Icons.lock_reset_outlined),
        ),
        if (_recoveryError != null) ...[
          const SizedBox(height: 12),
          _messageBox(_recoveryError!, error: true),
        ],
        if (_recoveryMessage != null) ...[
          const SizedBox(height: 12),
          _messageBox(_recoveryMessage!, error: false),
        ],
        const SizedBox(height: 12),
        SizedBox(
          height: 48,
          child: FilledButton(
            ...
            child: _recoveryLoading
                ...
                : const Text('إنشاء/إعادة تعيين حساب المالك'),
          ),
        ),
      ],
    );
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Icon(Icons.fingerprint_rounded, color: scheme.onPrimary, size: 22),
                      ),
                      const SizedBox(width: 10),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('حاضر', style: theme.textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w800)),
                          Text('HADIR · v1.1', style: TextStyle(color: scheme.onSurfaceVariant, fontSize: 10, fontFamily: 'monospace')),
                        ],
                      ),
                    ],
                  ),
                            ...
                            children: [
                              ...
                              if (_employeeAccessBlocked) ...[
                                    ...
                                    children: [
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: Column(
                                              crossAxisAlignment: CrossAxisAlignment.stretch,
                                              children: [
                                                const Text('هذه الواجهة مخصصة للإدارة', style: TextStyle(fontWeight: FontWeight.w900)),
                                                const SizedBox(height: 4),
                                                Text(
                                                  'يبدو أن بيانات الدخول تخص حساب موظف. لا يمكن استخدام حساب الموظف للدخول إلى لوحة الإدارة، ولن يتم تغيير ارتباط جهاز الموظف.',
                                                  style: TextStyle(color: scheme.onSurfaceVariant, fontSize: 13, height: 1.55),
                                                ),
                                              ],
                                            ),
                                      ...
                                      SizedBox(
                                        ...
                                        child: FilledButton(
                                          ...
                                          child: const Text('الانتقال إلى واجهة دخول الموظفين'),
                                        ),
                                      ),
                                    ],
                                  ),
                                ...
                                TextField(
                                  ...
                                  decoration: _inputDecoration(hint: 'أدخل اسم المستخدم', icon: Icons.person_outline_rounded),
                                ),
                                const SizedBox(height: 16),
                                ...
                                TextField(
                                  ...
                                  decoration: _inputDecoration(hint: 'أدخل كلمة المرور', icon: Icons.lock_outline_rounded).copyWith(
                              ...
                              const SizedBox(height: 12),
                              TextButton(
                                onPressed: _busy || _recoveryLoading
                                    ? null
                                    : () => setState(() {
                                        _recoveryOpen = !_recoveryOpen;
                                        _recoveryError = null;
                                        _recoveryMessage = null;
                                      }),
                                child: Text(_recoveryOpen ? 'إغلاق استعادة حساب المالك' : 'نسيت كلمة مرور المالك؟'),
                              ),
                              if (_recoveryOpen) ...[
                                const SizedBox(height: 4),
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: TextButton(
                                      ...
                                      child: const Text('دخول الموظفين'),
                                    ),
                                  ),
                                ],
                              ),
