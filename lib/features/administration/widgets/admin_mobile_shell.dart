...
class AdminMobileShell extends StatelessWidget {
  ...
  int _selectedIndex(BuildContext context) {
    ...
    if (path == '/manager/workforce') return 2;
        ...
        children: [
          ...
          _headerButton(
            ...
            onTap: () => Navigator.of(context).push(
              MaterialPageRoute(
                builder: (_) => const _AdminNotificationsPage(),
              ),
            ),
          ),
          const SizedBox(width: 4),
            ...
            child: Column(
              ...
              children: [
                ...
                _optionTile(
                  ...
                  Icons.groups_outlined,
                  'الموظفون',
                  'إدارة الموظفين وبياناتهم وصلاحياتهم',
                  '/manager/employees',
                ),
                _optionTile(
                  sheetContext,
                  Icons.assignment_ind_outlined,
                  'قوى العمل',
                  'المناوبات والتحضير والانصراف والإجراءات التلقائية',
                  '/manager/workforce',
                ),
                _optionTile(
                  sheetContext,
                  Icons.assignment_outlined,
                  'الطلبات',
                  'مراجعة طلبات الموظفين واتخاذ الإجراءات المناسبة',
                  '/manager/requests',
                ),
                _optionTile(
                  sheetContext,
                  Icons.fact_check_outlined,
                  'سجل التدقيق',
                  'مراجعة العمليات والأحداث الإدارية',
                  '/manager/audit',
                ),
                _optionTile(
                  sheetContext,
                  Icons.bar_chart_outlined,
                  'التقارير',
                  'تقارير الحضور وتحليل بيانات العمل',
                  '/manager/reports',
                ),
                _optionTile(
                  sheetContext,
                ...
                _optionTile(
                  ...
                  'الطقس',
                  'حالة الطقس والخدمات المرتبطة بالموقع',
                  '/weather',
                ),
                _optionTile(
                  sheetContext,
                  ...
                  'القبلة',
                  'اتجاه القبلة والخدمات المكانية',
                  '/prayer',
                ),
                _optionTile(
                  sheetContext,
