        ...
        bottomNavigationBar: NavigationBar(
          ...
          destinations: const [
            NavigationDestination(
              ...
              selectedIcon: Icon(Icons.dashboard_rounded, color: _brand),
              label: 'لوحة الموظف',
            ),
            NavigationDestination(
              icon: Icon(Icons.business_center_outlined),
              selectedIcon: Icon(Icons.business_center_rounded, color: _brand),
              label: 'مركز الموظف',
            ),
            NavigationDestination(
              icon: Icon(Icons.access_time_outlined),
              selectedIcon: Icon(Icons.access_time_filled, color: _brand),
              label: 'سجل العمل',
            ),
            NavigationDestination(
              icon: Icon(Icons.person_outline_rounded),
              selectedIcon: Icon(Icons.person_rounded, color: _brand),
              label: 'الملف الشخصي',
            ),
            NavigationDestination(
              icon: Icon(Icons.more_horiz_rounded),
              selectedIcon: Icon(Icons.more_horiz_rounded, color: _brand),
              label: 'المزيد',
            ),
          ],
        ),
