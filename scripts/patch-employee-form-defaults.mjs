...
// Repair the exact syntax emitted by older versions of this deterministic patch.
source = source.replace('rotationStartDate: "" }; return { ...v, [key]: value }; }), [];', 'rotationStartDate: "" }; return { ...v, [key]: value }; }), []);');
