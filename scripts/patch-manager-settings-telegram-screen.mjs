...
source = source.replace(
  detailOpen,
  '      </section> : <section ref={settingsDetailRef} className="settings-detail-screen fixed inset-0 z-[100] overflow-y-auto bg-background" aria-label="إعدادات القسم">'
);
