...
if (source.includes(headerCssAnchor) && !source.includes('.global-attendance-print-qr {')) {
  source = source.replace(headerCssAnchor, headerCssAnchor + '\n        .global-attendance-print-header { position: relative; }\n        .global-attendance-print-qr { position: absolute; top: 0; right: 0; width: 28mm; height: 28mm; }\n        .global-attendance-print-qr svg { display: block; width: 28mm !important; height: 28mm !important; }');
}

writeFileSync(file, source, "utf8");
console.log("GlobalAttendanceReports print QR patch: local QR with report date, extraction time, extractor name, and role.");
