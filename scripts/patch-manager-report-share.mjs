...
console.log("ManagerReports share patch: daily PDF is sent to the Worker for direct D1/R2 company-logo embedding, filename uses تقرير الحضور والغياب اليومي + company name + weekday + numeric date, and native sharing remains split into two explicit user gestures; monthly and annual CSV preserved.");
