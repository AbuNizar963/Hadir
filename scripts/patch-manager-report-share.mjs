...
if (!source.includes('from "@/lib/professionalPdf"') || !source.includes('const sharePdf = async') || !source.includes('readyPdf') || !source.includes('sharingPdf') || !hasRenderedShareControl || !hasRenderedPrintControl) {
...
console.log("ManagerReports share patch: daily PDF preparation and native sharing are split into two explicit user gestures to satisfy Navigator Share security; native print remains separate; monthly and annual CSV preserved.");
