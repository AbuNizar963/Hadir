...
console.log("ManagerReports share patch: daily CSV replaced by PDF sharing without blocking on a network refresh; PDF pages break at report section boundaries; monthly and annual CSV preserved.");
