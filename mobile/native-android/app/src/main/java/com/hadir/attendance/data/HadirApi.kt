...
data class Employee(val id: String, val name: String? = null, @Json(name = "jobNumber") val jobNumber: String? = null, val status: String? = null, val role: String? = null, @Json(name = "scheduleType") val scheduleType: String? = null, @Json(name = "rotationStartDate") val rotationStartDate: String? = null, @Json(name = "workStartTime") val workStartTime: String? = null, @Json(name = "workEndTime") val workEndTime: String? = null, @Json(name = "gracePeriodMinutes") val gracePeriodMinutes: Int? = null, @Json(name = "locationId") val locationId: String? = null)
...
data class AttendanceChallengeResponse(val ok: Boolean, val challengeId: String, val expiresAt: String, @Json(name = "error") val error: String? = null, val message: String? = null)
