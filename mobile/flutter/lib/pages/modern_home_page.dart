      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        ...
        Row(children: [
          ...
          SizedBox(width: 54, height: 54, child: FilledButton(
            ...
            style: FilledButton.styleFrom(backgroundColor: Colors.white.withOpacity(.14), foregroundColor: Colors.white, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(17)), padding: EdgeInsets.zero),
